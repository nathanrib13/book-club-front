  ...
  const books = [
    {
      ...
      readers: [
        { name: "Nathan", progress: 60, avatar: "https://i.ibb.co/n6Z8RtP/image.png", rating: 4.0 },
        { name: "Joao", progress: 75, avatar: "https://i.ibb.co/FwW9Jxf/image.png", rating: 4.5 },
        { name: "Gabriel", progress: 100, avatar: "https://i.ibb.co/4K2rPH5/image.png", rating: 5.0 },
        { name: "Igor", progress: 40, avatar: "https://i.ibb.co/bLfVfTz/image.png", rating: 3.5 },
      ],
      overallRating: 4.5,
    ...
    },
    {
      ...
      readers: [
        { name: "Nathan", progress: 23, avatar: "https://i.ibb.co/n6Z8RtP/image.png", rating: 4.5 },
        { name: "Joao", progress: 0, avatar: "https://i.ibb.co/FwW9Jxf/image.png", rating: 5.0 },
        { name: "Gabriel", progress: 15, avatar: "https://i.ibb.co/4K2rPH5/image.png", rating: 4.0 },
        { name: "Igor", progress: 23, avatar: "https://i.ibb.co/bLfVfTz/image.png", rating: 5.0 },
      ],
      overallRating: 5,
    ...
    },
    {
      ...
      readers: [
        { name: "Nathan", progress: 0, avatar: "https://i.ibb.co/n6Z8RtP/image.png", rating: 3.5 },
        { name: "Joao", progress: 0, avatar: "https://i.ibb.co/FwW9Jxf/image.png", rating: 3.0 },
        { name: "Gabriel", progress: 0, avatar: "https://i.ibb.co/4K2rPH5/image.png", rating: 4.0 },
        { name: "Igor", progress: 0, avatar: "https://i.ibb.co/bLfVfTz/image.png", rating: 4.5 },
      ],
      overallRating: 3.5,
